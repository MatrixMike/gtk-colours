...
gtk_about_dialog_set_website (GTK_ABOUT_DIALOG (dialog), "http://www.electroteach.com/mike");
gtk_about_dialog_set_website_label (GTK_ABOUT_DIALOG (dialog), "www.electroteach.com/mike");
